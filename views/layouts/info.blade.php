      ...
      <div class="col s12 m12 l8" id="theinfo">
          <div class="cover-latter z-depth-1">
              <div class="cover-title">
                ...
                @endphp
                  <div class="pull-right hide-on-small-only">
                    <a class="btn btn-sm waves-effect waves-light" target="_blank" href="https://www.canva.com/design/DACozt8IyVs/6VfpFh09p9IEHnU8pamqEg/view?utm_content=DACozt8IyVs&utm_campaign=designshare&utm_medium=link&utm_source=sharebutton">Ver CV <em><?= $act_cv ?></em></a>
                    <br><br>
                  </div>
              ...
              <h4 class="cover-title">
                {{-- Buenas! --}}
                <?= $texto ?>
                <i class="fa fa-fw fa-smile-o" aria-hidden="true" style="font-size:1.3em"></i>
              </h4>
              <div class="flow-text midescripcion">
                ...
                <p><i class="fa fa-fw fa-quote-left" aria-hidden="true" style="font-size:1.3em"></i> - Always code as if the guy who ends up maintaining your code will be a violent psychopath who knows where you live.</p>
              </div>
              <div class="signature">
